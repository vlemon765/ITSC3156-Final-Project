...
\begin{document}
    ...
    All the code provided in the jupyter notebook and this pdf file is my own, using homework from linear regression up until today as a reference to the project.

    \section{Source Code}
    https://github.com/vlemon765/ITSC3156-Final-Project/
